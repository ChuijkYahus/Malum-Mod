...
public class CodexLangDatagen {
    ...
    public static void generateEntries() {
        ...
        addPages("void.malignant_stronghold_armor",
                ...
                "The armor doesn't influence just inbound magic however. The wearer's own magic is redirected just as well, and in unraveling magic, energy still remains. The armor reacts to that energy, growing stronger alongside it. Any strictly defensive or offensive magical attribute that is to be inscribed upon my soul is instead absorbed by the metal, granting a potent defensive effect I dub Malignant Reinforcement.");
