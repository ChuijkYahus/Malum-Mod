...
public class MalumSoundDatagen extends SoundDefinitionsProvider {
    ...
    public void registerSounds() {
        ...
        this.add(SoundRegistry.SWAG_MESSIAH, s -> definition(s).with(sound("curiosities/augments/legalize_nuclear_bombs")));
        ...
        this.add(SoundRegistry.SPELL_CHARGE_GROW, s -> definition(s).with(sounds("curiosities/spell_charge/charge", 4)));
        this.add(SoundRegistry.SPELL_CHARGE_FULL, s -> definition(s).with(sounds("curiosities/spell_charge/charge_full", 4)));
        ...
        this.add(SoundRegistry.SPIRIT_BLAST, s -> definition(s).with(sounds("curiosities/geas/warlock_impact", 2)));
        ...
        this.add(SoundRegistry.SPIRIT_DIODE_LONG_TICK, s -> definition(s).with(sounds("blocks/spirit_diode/waveform_long_tick", 8)));
