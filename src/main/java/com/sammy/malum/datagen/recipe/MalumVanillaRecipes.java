...
public class MalumVanillaRecipes implements IConditionBuilder {
    ...
    protected static void buildRecipes(RecipeOutput output) {
        ...
        shapeless(RecipeCategory.MISC, MalumItems.RUNIC_SAP_BLOCK.get(), 8).requires(MalumItems.RUNIC_SAP.get(), 4).unlockedBy("has_runic_sap", has(MalumItems.RUNIC_SAP.get())).save(output);
        ...
        shapeless(RecipeCategory.MISC, MalumItems.CURSED_SAP_BLOCK.get(), 8).requires(MalumItems.CURSED_SAP.get(), 4).unlockedBy("has_cursed_sap", has(MalumItems.CURSED_SAP.get())).save(output);
