...
public class MalumVanillaRecipes implements IConditionBuilder {
    ...
    protected static void buildRecipes(RecipeOutput output) {
        ...
        nodeSmelting(output, ItemRegistry.COBALT_NODE, NUGGETS_COBALT);
        ...
        smeltingWithCount(Ingredient.of(ItemRegistry.BRILLIANT_STONE.get()), RecipeCategory.MISC, ItemRegistry.REFINED_BRILLIANCE.get(), 2, 1, 200).unlockedBy("has_brilliance", has(ItemRegistry.RAW_BRILLIANCE.get())).save(output, malumPath("brilliance_from_smelting"));
        blastingWithCount(Ingredient.of(ItemRegistry.BRILLIANT_STONE.get()), RecipeCategory.MISC, ItemRegistry.REFINED_BRILLIANCE.get(), 2, 1, 100).unlockedBy("has_brilliance", has(ItemRegistry.RAW_BRILLIANCE.get())).save(output, malumPath("brilliance_from_blasting"));
        smeltingWithCount(Ingredient.of(ItemRegistry.BRILLIANT_DEEPSLATE.get()), RecipeCategory.MISC, ItemRegistry.REFINED_BRILLIANCE.get(), 2, 1, 200).unlockedBy("has_brilliance", has(ItemRegistry.RAW_BRILLIANCE.get())).save(output, malumPath("brilliance_from_deepslate_smelting"));
        blastingWithCount(Ingredient.of(ItemRegistry.BRILLIANT_DEEPSLATE.get()), RecipeCategory.MISC, ItemRegistry.REFINED_BRILLIANCE.get(), 2, 1, 100).unlockedBy("has_brilliance", has(ItemRegistry.RAW_BRILLIANCE.get())).save(output, malumPath("brilliance_from_deepslate_blasting"));
        ...
        smeltingWithCount(Ingredient.of(ItemRegistry.RAW_BRILLIANCE.get()), RecipeCategory.MISC, ItemRegistry.REFINED_BRILLIANCE.get(), 2, 1, 200).unlockedBy("has_brilliance", has(ItemRegistry.RAW_BRILLIANCE.get())).save(output, malumPath("brilliance_from_raw_smelting"));
        blastingWithCount(Ingredient.of(ItemRegistry.RAW_BRILLIANCE.get()), RecipeCategory.MISC, ItemRegistry.REFINED_BRILLIANCE.get(), 2, 1, 100).unlockedBy("has_brilliance", has(ItemRegistry.RAW_BRILLIANCE.get())).save(output, malumPath("brilliance_from_raw_blasting"));
        smeltingWithCount(Ingredient.of(ItemRegistry.CRUSHED_BRILLIANCE.get()), RecipeCategory.MISC, ItemRegistry.REFINED_BRILLIANCE.get(), 2, 1, 200).unlockedBy("has_brilliance", has(ItemRegistry.RAW_BRILLIANCE.get())).save(output, malumPath("brilliance_from_crushed_smelting"));
        blastingWithCount(Ingredient.of(ItemRegistry.CRUSHED_BRILLIANCE.get()), RecipeCategory.MISC, ItemRegistry.REFINED_BRILLIANCE.get(), 2, 1, 100).unlockedBy("has_brilliance", has(ItemRegistry.RAW_BRILLIANCE.get())).save(output, malumPath("brilliance_from_crushed_blasting"));
        ...
        shaped(RecipeCategory.MISC, ItemRegistry.BLOCK_OF_BRILLIANCE.get()).define('#', ItemRegistry.RAW_BRILLIANCE.get()).pattern("###").pattern("###").pattern("###").unlockedBy("has_brilliance", has(ItemRegistry.RAW_BRILLIANCE.get())).save(output, malumPath("block_of_brilliance"));
        shapeless(RecipeCategory.MISC, ItemRegistry.RAW_BRILLIANCE.get(), 9).requires(ItemRegistry.BLOCK_OF_BRILLIANCE.get()).unlockedBy("has_brilliance", has(ItemRegistry.RAW_BRILLIANCE.get())).save(output, malumPath("brilliance_from_block"));
        ...
        shaped(RecipeCategory.MISC, ItemRegistry.BLOCK_OF_LIVING_FLESH.get()).define('#', ItemRegistry.LIVING_FLESH.get()).pattern("###").pattern("###").pattern("###").unlockedBy("has_living_flesh", has(ItemRegistry.LIVING_FLESH.get())).save(output, malumPath("block_of_living_flesh"));
        shapeless(RecipeCategory.MISC, ItemRegistry.LIVING_FLESH.get(), 9).requires(ItemRegistry.BLOCK_OF_LIVING_FLESH.get()).unlockedBy("has_living_flesh", has(ItemRegistry.LIVING_FLESH.get())).save(output, malumPath("living_flesh_from_block"));
        ...
        shapeless(RecipeCategory.MISC, Items.EXPERIENCE_BOTTLE).requires(ItemRegistry.REFINED_BRILLIANCE.get()).requires(Items.GLASS_BOTTLE).unlockedBy("has_brilliance", has(ItemRegistry.REFINED_BRILLIANCE.get())).save(output, malumPath("experience_bottle_from_brilliance"));
