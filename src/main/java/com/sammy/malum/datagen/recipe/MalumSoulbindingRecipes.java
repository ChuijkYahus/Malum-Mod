...
public class MalumSoulbindingRecipes implements IConditionBuilder {
    ...
    protected static void buildRecipes(RecipeOutput recipeOutput) {
        new SoulBindingRecipeBuilder(MalumItems.LIVING_FLESH.get(), 12, MalumGeasEffectTypes.PACT_OF_DEFIANCE)
                ...
                .save(recipeOutput);
        new SoulBindingRecipeBuilder(MalumItems.LIVING_FLESH.get(), 12, MalumGeasEffectTypes.PACT_OF_THE_PARASITE)
                ...
                .save(recipeOutput);
        new SoulBindingRecipeBuilder(MalumItems.IMITATION_FLESH.get(), 8, MalumGeasEffectTypes.PACT_OF_THE_LIFEWEAVER)
                .addExtraItem(Items.GOLDEN_CARROT, 4)
        ...
        new SoulBindingRecipeBuilder(MalumItems.REFINED_SOULSTONE.get(), 12, MalumGeasEffectTypes.PACT_OF_THE_WARLOCK)
                .addExtraItem(MalumItems.ARCANE_CHARCOAL.get(), 4)
                .addExtraItem(MalumItems.HEX_ASH.get(), 4)
                .addSpirit(MalumSpiritTypes.WICKED_SPIRIT, 16)
                .addSpirit(MalumSpiritTypes.AQUEOUS_SPIRIT, 16)
                .save(recipeOutput);
        new SoulBindingRecipeBuilder(MalumItems.REFINED_SOULSTONE.get(), 12, MalumGeasEffectTypes.PACT_OF_THE_REAPER)
                ...
                .addSpirit(MalumSpiritTypes.INFERNAL_SPIRIT, 16)
                .save(recipeOutput);
        new SoulBindingRecipeBuilder(MalumItems.IMITATION_HEART.get(), 8, MalumGeasEffectTypes.PACT_OF_THE_BERSERKER)
                .addExtraItem(MalumItems.LIVING_FLESH.get(), 16)
                .addExtraItem(MalumItems.GRIM_TALC.get(), 16)
        ...
        new SoulBindingRecipeBuilder(MalumItems.SOUL_STAINED_STEEL_PLATING.get(), 12, MalumGeasEffectTypes.PACT_OF_THE_FORTRESS)
                .addExtraItem(MalumItems.REFINED_SOULSTONE.get(), 8)
                .addSpirit(MalumSpiritTypes.ARCANE_SPIRIT, 16)
                .addSpirit(MalumSpiritTypes.EARTHEN_SPIRIT, 16)
                .save(recipeOutput);
        new SoulBindingRecipeBuilder(MalumItems.SOUL_STAINED_STEEL_PLATING.get(), 12, MalumGeasEffectTypes.PACT_OF_THE_SHIELD)
                .addExtraItem(MalumItems.REFINED_SOULSTONE.get(), 8)
                .addSpirit(MalumSpiritTypes.ARCANE_SPIRIT, 16)
                .addSpirit(MalumSpiritTypes.AERIAL_SPIRIT, 16)
                .addSpirit(MalumSpiritTypes.AQUEOUS_SPIRIT, 16)
                .save(recipeOutput);
        new SoulBindingRecipeBuilder(MalumItems.IMITATION_FLESH.get(), 8, MalumGeasEffectTypes.PACT_OF_RECIPROCATION)
                .addExtraItem(MalumItems.WARP_FLUX.get(), 8)
                .addExtraItem(MalumItems.REFINED_SOULSTONE.get(), 8)
                .addExtraItem(MalumItems.SOUL_STAINED_STEEL_PLATING.get(), 8)
                .addSpirit(MalumSpiritTypes.ARCANE_SPIRIT, 32)
        ...
        new SoulBindingRecipeBuilder(MalumItems.RAW_SOULSTONE.get(), 12, MalumGeasEffectTypes.PACT_OF_THE_SHATTERING_ADDICT)
                .addExtraItem(MalumItems.HEX_ASH.get(), 8)
                .addExtraItem(MalumItems.WARP_FLUX.get(), 4)
                .addSpirit(MalumSpiritTypes.ELDRITCH_SPIRIT, 16)
                .addSpirit(MalumSpiritTypes.WICKED_SPIRIT, 16)
                .save(recipeOutput);
        new SoulBindingRecipeBuilder(MalumItems.RAW_SOULSTONE.get(), 12, MalumGeasEffectTypes.PACT_OF_THE_ARCANAPHAGE)
                .addExtraItem(MalumItems.WARP_FLUX.get(), 8)
                .addExtraItem(MalumItems.SOUL_STAINED_STEEL_PLATING.get(), 4)
                .addSpirit(MalumSpiritTypes.ELDRITCH_SPIRIT, 16)
                .addSpirit(MalumSpiritTypes.ARCANE_SPIRIT, 16)
                .addSpirit(MalumSpiritTypes.WICKED_SPIRIT, 16)
                .save(recipeOutput);
        new SoulBindingRecipeBuilder(MalumItems.IMITATION_HEART.get(), 8, MalumGeasEffectTypes.PACT_OF_RUNE_EXPLOITATION)
                .addExtraItem(MalumItems.WARP_FLUX.get(), 8)
                .addExtraItem(MalumItems.REFINED_SOULSTONE.get(), 8)
                .addExtraItem(MalumItems.HEX_ASH.get(), 8)
        ...
        new SoulBindingRecipeBuilder(Ingredient.of(ItemTags.SAPLINGS), 12, MalumGeasEffectTypes.PACT_OF_THE_LONE_DRUID)
                ...
                .addSpirit(MalumSpiritTypes.ARCANE_SPIRIT, 16)
                .save(recipeOutput);
        new SoulBindingRecipeBuilder(MalumItems.ROTTING_ESSENCE.get(), 16, MalumGeasEffectTypes.PACT_OF_THE_PROFANE_ASCETIC)
                .addExtraItem(MalumItems.IMITATION_FLESH.get(), 8)
                ...
                .addSpirit(MalumSpiritTypes.ELDRITCH_SPIRIT, 16)
                .save(recipeOutput);
        new SoulBindingRecipeBuilder(MalumItems.ROTTING_ESSENCE.get(), 16, MalumGeasEffectTypes.PACT_OF_THE_PROFANE_GLUTTON)
                .addExtraItem(MalumItems.IMITATION_HEART.get(), 8)
                .addExtraItem(Items.ROTTEN_FLESH, 8)
        ...
        new SoulBindingRecipeBuilder(MalumItems.MNEMONIC_FRAGMENT.get(), 8, MalumGeasEffectTypes.OATH_OF_THE_OVERKEEN_EYE)
        ...
        new SoulBindingRecipeBuilder(MalumItems.MNEMONIC_FRAGMENT.get(), 8, MalumGeasEffectTypes.OATH_OF_THE_OVERBURDENED_MIND)
                ...
                .addSpirit(MalumSpiritTypes.ELDRITCH_SPIRIT, 32)
                .save(recipeOutput);
        new SoulBindingRecipeBuilder(MalumItems.MNEMONIC_FRAGMENT.get(), 8, MalumGeasEffectTypes.OATH_OF_THE_OVEREAGER_FIST)
        ...
        new SoulBindingRecipeBuilder(MalumItems.MALIGNANT_PEWTER_PLATING.get(), 8, MalumGeasEffectTypes.OATH_OF_UNMAKERS_DISDAIN)
                .addExtraItem(MalumItems.VOID_SALTS.get(), 8)
                .addExtraItem(MalumItems.IMITATION_FLESH.get(), 4)
                .addSpirit(MalumSpiritTypes.WICKED_SPIRIT, 32)
                .addSpirit(MalumSpiritTypes.ARCANE_SPIRIT, 32)
                .addSpirit(MalumSpiritTypes.ELDRITCH_SPIRIT, 32)
                .save(recipeOutput);
        new SoulBindingRecipeBuilder(MalumItems.MALIGNANT_PEWTER_PLATING.get(), 8, MalumGeasEffectTypes.OATH_OF_UNSIGHTED_RESISTANCE)
                ...
                .addSpirit(MalumSpiritTypes.ELDRITCH_SPIRIT, 32)
                .save(recipeOutput);
        new SoulBindingRecipeBuilder(MalumItems.MALIGNANT_PEWTER_PLATING.get(), 8, MalumGeasEffectTypes.OATH_OF_THE_UNDISCERNED_MAW)
        ...
        new SoulBindingRecipeBuilder(MalumItems.FUSED_CONSCIOUSNESS.get(), 1, MalumGeasEffectTypes.AUTHORITY_OF_THE_GLEEFUL_TARGET)
                .addExtraItem(MalumItems.MALIGNANT_PEWTER_PLATING.get(), 16)
                .addExtraItem(MalumItems.IMITATION_FLESH.get(), 16)
                ...
                .addSpirit(MalumSpiritTypes.INFERNAL_SPIRIT, 32)
                .save(recipeOutput);
        new SoulBindingRecipeBuilder(MalumItems.FUSED_CONSCIOUSNESS.get(), 1, MalumGeasEffectTypes.AUTHORITY_OF_THE_INVERTED_HEART)
                .addExtraItem(MalumItems.MALIGNANT_PEWTER_PLATING.get(), 16)
                .addExtraItem(MalumItems.IMITATION_HEART.get(), 16)
                .addExtraItem(MalumItems.MNEMONIC_FRAGMENT.get(), 16)
                .addSpirit(MalumSpiritTypes.SACRED_SPIRIT, 32)
                .addSpirit(MalumSpiritTypes.WICKED_SPIRIT, 32)
                .addSpirit(MalumSpiritTypes.ARCANE_SPIRIT, 32)
                .addSpirit(MalumSpiritTypes.ELDRITCH_SPIRIT, 32)
