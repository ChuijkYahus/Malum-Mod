...
public class MalumGeasEffectTypes {
    ...
    public static final GeasHolder<GeasEffectType> PACT_OF_THE_WARLOCK = GEAS_TYPES.register("pact_of_the_warlock", () -> new GeasEffectType(WarlockGeas::new, WICKED_SPIRIT, AQUEOUS_SPIRIT));
    public static final GeasHolder<GeasEffectType> PACT_OF_THE_REAPER = GEAS_TYPES.register("pact_of_the_reaper", () -> new GeasEffectType(ReaperGeas::new, WICKED_SPIRIT, AERIAL_SPIRIT));
    public static final GeasHolder<GeasEffectType> PACT_OF_THE_BERSERKER = GEAS_TYPES.register("pact_of_the_berserker", () -> new GeasEffectType(BerserkerGeas::new, WICKED_SPIRIT, ELDRITCH_SPIRIT));

    public static final GeasHolder<GeasEffectType> PACT_OF_THE_FORTRESS = GEAS_TYPES.register("pact_of_the_fortress", () -> new GeasEffectType(FortressGeas::new, ARCANE_SPIRIT, AQUEOUS_SPIRIT));
    public static final GeasHolder<GeasEffectType> PACT_OF_THE_SHIELD = GEAS_TYPES.register("pact_of_the_shield", () -> new GeasEffectType(ShieldGeas::new, ARCANE_SPIRIT, AERIAL_SPIRIT));
    public static final GeasHolder<GeasEffectType> PACT_OF_RECIPROCATION = GEAS_TYPES.register("pact_of_reciprocation", () -> new GeasEffectType(ReciprocationGeas::new, ARCANE_SPIRIT, ELDRITCH_SPIRIT));

    public static final GeasHolder<GeasEffectType> PACT_OF_THE_SHATTERING_ADDICT = GEAS_TYPES.register("pact_of_the_shattering_addict", () -> new GeasEffectType(ShatteringAddictGeas::new, ELDRITCH_SPIRIT));
    public static final GeasHolder<GeasEffectType> PACT_OF_THE_ARCANAPHAGE = GEAS_TYPES.register("pact_of_the_arcanaphage", () -> new GeasEffectType(ArcanaphageGeas::new, ELDRITCH_SPIRIT));
    public static final GeasHolder<GeasEffectType> PACT_OF_RUNE_EXPLOITATION = GEAS_TYPES.register("pact_of_rune_exploitation", () -> new GeasEffectType(RuneExploitationGeas::new, ELDRITCH_SPIRIT));
    ...
    public static final GeasHolder<GeasEffectType> PACT_OF_THE_LONE_DRUID = GEAS_TYPES.register("pact_of_the_lone_druid", () -> new GeasEffectType(LoneDruidGeas::new, EARTHEN_SPIRIT, ARCANE_SPIRIT));
    public static final GeasHolder<GeasEffectType> PACT_OF_THE_PROFANE_ASCETIC = GEAS_TYPES.register("pact_of_the_profane_ascetic", () -> new GeasEffectType(ProfaneAsceticGeas::new, EARTHEN_SPIRIT, SACRED_SPIRIT));
    public static final GeasHolder<GeasEffectType> PACT_OF_THE_PROFANE_GLUTTON = GEAS_TYPES.register("pact_of_the_profane_glutton", () -> new GeasEffectType(ProfaneGluttonGeas::new, EARTHEN_SPIRIT, WICKED_SPIRIT));
...
//    public static final GeasHolder<GeasEffectType> BOND_OF_BELOVED_CHAINS = GEAS_TYPES.register("bond_of_beloved_chains", () -> new GeasEffectType(BelovedChainsBond::new, SACRED_SPIRIT, EARTHEN_SPIRIT, ELDRITCH_SPIRIT));
...
//    public static final GeasHolder<GeasEffectType> BOND_OF_DEATHS_SEEKERS = GEAS_TYPES.register("bond_of_deaths_seekers", () -> new GeasEffectType(DeathsSeekersBond::new, WICKED_SPIRIT, INFERNAL_SPIRIT, ELDRITCH_SPIRIT));



    public static final GeasHolder<GeasEffectType> OATH_OF_THE_OVERKEEN_EYE = GEAS_TYPES.register("oath_of_the_overkeen_eye", () -> new GeasEffectType(OverkeenEyeGeas::new, ARCANE_SPIRIT, AERIAL_SPIRIT, ELDRITCH_SPIRIT));
    public static final GeasHolder<GeasEffectType> OATH_OF_THE_OVERBURDENED_MIND = GEAS_TYPES.register("oath_of_the_overburdened_mind", () -> new GeasEffectType(OverburdenedMindGeas::new, ARCANE_SPIRIT, AQUEOUS_SPIRIT, ELDRITCH_SPIRIT));
    public static final GeasHolder<GeasEffectType> OATH_OF_THE_OVEREAGER_FIST = GEAS_TYPES.register("oath_of_the_overeager_fist", () -> new GeasEffectType(OvereagerFistGeas::new, ARCANE_SPIRIT, INFERNAL_SPIRIT, ELDRITCH_SPIRIT));

    public static final GeasHolder<GeasEffectType> OATH_OF_UNMAKERS_DISDAIN = GEAS_TYPES.register("oath_of_unmakers_disdain", () -> new GeasEffectType(UnmakersDisdainGeas::new, ARCANE_SPIRIT, WICKED_SPIRIT, ELDRITCH_SPIRIT));
    public static final GeasHolder<GeasEffectType> OATH_OF_UNSIGHTED_RESISTANCE = GEAS_TYPES.register("oath_of_unsighted_resistance", () -> new GeasEffectType(UnsightedResistanceGeas::new, ARCANE_SPIRIT, EARTHEN_SPIRIT, ELDRITCH_SPIRIT));
