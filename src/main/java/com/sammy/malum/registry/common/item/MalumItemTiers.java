...
public enum MalumItemTiers implements Tier{
    ...
    RAVENOUS(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, 1500, 7.5f, 2.5f, 24, MalumItems.GRIM_TALC),
    ...
    HARNESSED_CHAOS(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, 2500, 8f, 2.5f, 24, MalumItems.FUSED_CONSCIOUSNESS),

    TYRVING(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, 1500, 8f, 1f, 16, MalumItems.TWISTED_ROCK),
    HEX_STAFF(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, 1250, 8f, 2.5f, 16, MalumItems.MNEMONIC_FRAGMENT);
    ...
    MalumItemTiers(TagKey<Block> incorrectBlockForDrops, int uses, float speed, float damage, int enchantmentValue, Supplier<Item> repairItem) {
