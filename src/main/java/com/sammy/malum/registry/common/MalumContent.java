...
import static com.sammy.malum.registry.common.item.MalumItemProperties.COSMETIC_PROPERTIES;
...
public class MalumContent {
    ...
    public static final BlockBlockItemHolder<Block, BlockItem> BLIGHTED_SOULWOOD = registerBlock("blighted_soulwood", () -> new BlightedSoulwoodBlock(SOULWOOD_LOGS()));
    //region hidden items
    ...
    public static class Materials {
        ...
        public static final BlockBlockItemHolder<Block, BlockItem> NATURAL_QUARTZ = registerItemNameBlock("natural_quartz_cluster", "natural_quartz", () -> new AmethystClusterBlock(6, 3, NATURAL_QUARTZ_CLUSTER().setCutoutRenderType()));
        ...
        public static final BlockBlockItemHolder<Block, BlockItem> CTHONIC_GOLD_FRAGMENT = registerItemNameBlock("cthonic_gold_cluster", "cthonic_gold_fragment", () -> new AmethystClusterBlock(4, 3, CTHONIC_GOLD_CLUSTER().setCutoutRenderType()));
    ...
    public static class BlockSets {
        ...
        public static final BlockBlockItemHolder<Block, BlockItem> SOULWOVEN_BANNER = registerBlock("soulwoven_banner", () -> new SoulwovenBannerBlock(SOULWOVEN_BANNER()).setBlockEntity(MalumBlockEntities.SOULWOVEN_BANNER), SoulwovenBannerBlockItem::new);

        public static final BlockBlockItemHolder<Block, BlockItem> ETHER = registerEtherBlock("ether", () -> new EtherBlock<>(ETHER()).setBlockEntity(MalumBlockEntities.ETHER));
        public static final BlockBlockItemHolder<Block, BlockItem> IRIDESCENT_ETHER = registerEtherIridescentBlock("iridescent_ether", () -> new EtherBlock<>(ETHER()).setBlockEntity(MalumBlockEntities.ETHER));

        public static final BlockBlockItemHolder<Block, BlockItem> ETHER_CANDLE = registerEtherBlock("ether_candle", () -> new EtherCandleBlock<>(ETHER_CANDLE()).setBlockEntity(MalumBlockEntities.ETHER_CANDLE));
        public static final BlockBlockItemHolder<Block, BlockItem> IRIDESCENT_ETHER_CANDLE = registerEtherIridescentBlock("iridescent_ether_candle", () -> new EtherCandleBlock<>(ETHER_CANDLE()).setBlockEntity(MalumBlockEntities.ETHER_CANDLE));

        public static final BlockBlockItemHolder<Block, BlockItem> ETHER_TORCH = registerEtherBlock("ether_torch", () -> new EtherTorchBlock<>(ETHER_TORCH()).setBlockEntity(MalumBlockEntities.ETHER_TORCH));
        public static final DeferredBlock<Block> WALL_ETHER_TORCH = registerBlockNoItem("wall_ether_torch", () -> new EtherWallTorchBlock<>(ETHER_TORCH().lootFrom(ETHER_TORCH)).setBlockEntity(MalumBlockEntities.ETHER_TORCH));
        public static final BlockBlockItemHolder<Block, BlockItem> IRIDESCENT_ETHER_TORCH = registerEtherIridescentBlock("iridescent_ether_torch", () -> new EtherTorchBlock<>(ETHER_TORCH()).setBlockEntity(MalumBlockEntities.ETHER_TORCH));
        public static final DeferredBlock<Block> IRIDESCENT_WALL_ETHER_TORCH = registerBlockNoItem("iridescent_wall_ether_torch", () -> new EtherWallTorchBlock<>(ETHER_TORCH().lootFrom(IRIDESCENT_ETHER_TORCH)).setBlockEntity(MalumBlockEntities.ETHER_TORCH));

        public static final BlockBlockItemHolder<Block, BlockItem> ETHER_BRAZIER = MalumContent.registerEtherBlock("ether_brazier",
                () -> new EtherBrazierBlock<>(MalumBlockProperties.ETHER_BRAZIER()).setBlockEntity(MalumBlockEntities.ETHER_BRAZIER));
        public static final BlockBlockItemHolder<Block, BlockItem> IRIDESCENT_ETHER_BRAZIER = MalumContent.registerEtherIridescentBlock("iridescent_ether_brazier",
                () -> new EtherBrazierBlock<>(MalumBlockProperties.ETHER_BRAZIER()).setBlockEntity(MalumBlockEntities.ETHER_BRAZIER));

        public static final BlockBlockItemHolder<Block, BlockItem> ETHER_CRESSET = MalumContent.registerEtherBlock("ether_cresset",
                () -> new EtherCressetBlock<>(MalumBlockProperties.ETHER_CRESSET()).setBlockEntity(MalumBlockEntities.ETHER_CRESSET));
        public static final BlockBlockItemHolder<Block, BlockItem> IRIDESCENT_ETHER_CRESSET = MalumContent.registerEtherIridescentBlock("iridescent_ether_cresset",
                () -> new EtherCressetBlock<>(MalumBlockProperties.ETHER_CRESSET()).setBlockEntity(MalumBlockEntities.ETHER_CRESSET));

        public static final RockBlockSet TAINTED_ROCK_SET = new RockBlockSet("tainted", MalumBlockProperties::TAINTED_ROCK, MalumBlockProperties::TAINTED_ROCK_BRICKS, MalumBlockProperties::CHISELED_TAINTED_ROCK);
        public static final RockBlockSet TWISTED_ROCK_SET = new RockBlockSet("twisted", MalumBlockProperties::TWISTED_ROCK, MalumBlockProperties::TWISTED_ROCK_BRICKS, MalumBlockProperties::CHISELED_TWISTED_ROCK);
        ...
        public static final BlockBlockItemHolder<Block, BlockItem> RUNEWOOD_LEAVES = registerBlock("runewood_leaves", () -> new MalumLeavesBlock(RUNEWOOD_LEAVES(), RUNEWOOD_LEAVES_ORANGE, RUNEWOOD_LEAVES_YELLOW));
        public static final BlockBlockItemHolder<Block, BlockItem> HANGING_RUNEWOOD_LEAVES = registerBlock("hanging_runewood_leaves", () -> new MalumHangingLeavesBlock(HANGING_RUNEWOOD_LEAVES().setCutoutRenderType().noOcclusion().noCollission(), RUNEWOOD_LEAVES_ORANGE, RUNEWOOD_LEAVES_YELLOW));
        ...
        public static final BlockBlockItemHolder<Block, BlockItem> AZURE_RUNEWOOD_LEAVES = registerBlock("azure_runewood_leaves", () -> new MalumLeavesBlock(RUNEWOOD_LEAVES(), AZURE_RUNEWOOD_LEAVES_BLUE, AZURE_RUNEWOOD_LEAVES_CYAN));
        public static final BlockBlockItemHolder<Block, BlockItem> HANGING_AZURE_RUNEWOOD_LEAVES = registerBlock("hanging_azure_runewood_leaves", () -> new MalumHangingLeavesBlock(HANGING_RUNEWOOD_LEAVES().setCutoutRenderType().noOcclusion().noCollission(), AZURE_RUNEWOOD_LEAVES_BLUE, AZURE_RUNEWOOD_LEAVES_CYAN));

        public static final WoodBlockSet RUNEWOOD_SET = new WoodBlockSet("runewood", "gilded", () -> MalumBlockSetTypes.RUNEWOOD, MalumBlockProperties.RUNEWOOD_LOGS(), MalumBlockProperties.RUNEWOOD());
        public static final DeferredItem<Item> RUNEWOOD_BOAT = register("runewood_boat", () -> MalumItemProperties.DEFAULT_PROPERTIES().stacksTo(1), (p) -> new BoatItem(false, MalumEnumParams.RUNEWOOD_BOAT_TYPE.getValue(), p));
        public static final DeferredItem<Item> RUNEWOOD_CHEST_BOAT = register("runewood_chest_boat", () -> MalumItemProperties.DEFAULT_PROPERTIES().stacksTo(1), (p) -> new BoatItem(true, MalumEnumParams.RUNEWOOD_BOAT_TYPE.getValue(), p));


        public static final Color SOULWOOD_LEAVES_RED = new Color(213, 8, 63);
        public static final Color SOULWOOD_LEAVES_PINK = new Color(255, 61, 243);
        ...
        public static final BlockBlockItemHolder<Block, BlockItem> SOULWOOD_LEAVES = registerBlock("soulwood_leaves", () -> new MalumLeavesBlock(SOULWOOD_LEAVES().setCutoutRenderType(), SOULWOOD_LEAVES_RED, SOULWOOD_LEAVES_PINK));

        public static final BlockBlockItemHolder<Block, BlockItem> HANGING_SOULWOOD_LEAVES = registerBlock("hanging_soulwood_leaves", () -> new MalumHangingLeavesBlock(HANGING_SOULWOOD_LEAVES().setCutoutRenderType().noOcclusion().noCollission(), SOULWOOD_LEAVES_RED, SOULWOOD_LEAVES_PINK));

        public static final WoodBlockSet SOULWOOD_SET = new WoodBlockSet("soulwood", "ornate", () -> MalumBlockSetTypes.SOULWOOD, MalumBlockProperties.SOULWOOD_LOGS(), MalumBlockProperties.SOULWOOD());
        public static final DeferredItem<Item> SOULWOOD_BOAT = register("soulwood_boat", () -> MalumItemProperties.DEFAULT_PROPERTIES().stacksTo(1), (p) -> new BoatItem(false, MalumEnumParams.SOULWOOD_BOAT_TYPE.getValue(), p));
        public static final DeferredItem<Item> SOULWOOD_CHEST_BOAT = register("soulwood_chest_boat", () -> MalumItemProperties.DEFAULT_PROPERTIES().stacksTo(1), (p) -> new BoatItem(true, MalumEnumParams.SOULWOOD_BOAT_TYPE.getValue(), p));
    ...
    public static class Blight {
        ...
        public static final BlockBlockItemHolder<Block, BlockItem> COLUMNAR_BLIGHT = registerBlock("columnar_blight", () -> new ColumnarBlightBlock(BLIGHTED_EARTH()));
        public static final BlockBlockItemHolder<Block, BlockItem> BLIGHTED_EARTH = registerBlock("blighted_earth", () -> new BlightedEarthBlock(BLIGHTED_EARTH()));

        public static final BlockBlockItemHolder<Block, BlockItem> BLIGHT = registerBlock("blight", () -> new BlightedCoverageBlock(BLIGHTED_COVERING()));
        public static final DeferredBlock<Block> CLINGING_BLIGHT = registerBlockNoItem("clinging_blight", () -> new CreepingBlightBlock(CLINGING_BLIGHT()));
        public static final BlockBlockItemHolder<Block, BlockItem> BLIGHTED_GUNK = registerBlock("blighted_growth", "blighted_gunk", () -> new BlightedPlantBlock(BLIGHTED_PLANTS()), BlightedGunkItem::new);

        public static final BlockBlockItemHolder<Block, BlockItem> BLIGHTPEARL = registerBlock("blightpearl", () -> new BlightedPlantBlock(BLIGHTED_PLANTS()));
        public static final BlockBlockItemHolder<Block, BlockItem> BLIGHTROOT = registerBlock("blightroot", () -> new BlightedPlantBlock(BLIGHTED_PLANTS()));

        public static final BlockBlockItemHolder<Block, BlockItem> SCARSTONE = registerBlock("scarstone", () -> new ScarstoneBlock(SCARSTONE()));
        public static final BlockBlockItemHolder<Block, BlockItem> STRANGE_CRYSTAL = registerBlock("strange_crystal", () -> new StrangeCrystalBlock(STRANGE_CRYSTAL()));
        public static final BlockBlockItemHolder<Block, BlockItem> LARGE_STRANGE_CRYSTAL = registerBlock("large_strange_crystal", () -> new LargeStrangeCrystalBlock(STRANGE_CRYSTAL()));
        public static final BlockBlockItemHolder<Block, BlockItem> STRANGEROOT = registerBlock("strangeroot", () -> new StrangeRootBlock(STRANGEROOT()));
    ...
    public static class Totemancy {
        ...
        public static final DeferredItem<Item> TOTEMIC_STAFF = register("totemic_staff", MalumItemProperties::GEAR_PROPERTIES, TinkeringToolItem::new);

        public static final BlockBlockItemHolder<Block, BlockItem> RUNEWOOD_TOTEM_BASE = registerBlock("runewood_totem_base", () -> new TotemBaseBlock<>(RUNEWOOD().addTag(IS_RITE_IMMUNE).noOcclusion(), false).setBlockEntity(MalumBlockEntities.TOTEM_BASE));
        public static final BlockBlockItemHolder<Block, BlockItem> SOULWOOD_TOTEM_BASE = registerBlock("soulwood_totem_base", () -> new TotemBaseBlock<>(SOULWOOD().addTag(IS_RITE_IMMUNE).noOcclusion(), true).setBlockEntity(MalumBlockEntities.TOTEM_BASE));

        public static final BlockBlockItemHolder<Block, BlockItem> WAVEFORM_RUNEWOOD_TOTEM_BASE = registerBlock("waveform_runewood_totem_base", () -> new WaveformTotemBaseBlock<>(WAVEFORM_DIODE().addTag(IS_RITE_IMMUNE).noOcclusion(), false).setBlockEntity(MalumBlockEntities.WAVEFORM_TOTEM_BASE));
        public static final BlockBlockItemHolder<Block, BlockItem> WAVEFORM_SOULWOOD_TOTEM_BASE = registerBlock("waveform_soulwood_totem_base", () -> new WaveformTotemBaseBlock<>(WAVEFORM_DIODE().addTag(IS_RITE_IMMUNE).noOcclusion(), true).setBlockEntity(MalumBlockEntities.WAVEFORM_TOTEM_BASE));

        public static final DeferredBlock<Block> RUNEWOOD_TOTEM_POLE = registerBlockNoItem("runewood_totem_pole", () -> new TotemPoleBlock<>(RUNEWOOD().addTag(IS_RITE_IMMUNE).noOcclusion(), BlockSets.RUNEWOOD_SET.getLog(), false).setBlockEntity(MalumBlockEntities.TOTEM_POLE));
        public static final DeferredBlock<Block> SOULWOOD_TOTEM_POLE = registerBlockNoItem("soulwood_totem_pole", () -> new TotemPoleBlock<>(SOULWOOD().addTag(IS_RITE_IMMUNE).noOcclusion(), BlockSets.SOULWOOD_SET.getLog(), true).setBlockEntity(MalumBlockEntities.TOTEM_POLE));

        public static final BlockBlockItemHolder<Block, BlockItem> RITE_ANCHOR = registerBlock("rite_anchor", () -> new RiteAnchorBlock(TAINTED_ROCK_TOTEMANCY()).setBlockEntity(MalumBlockEntities.RITE_ANCHOR));
        public static final BlockBlockItemHolder<Block, BlockItem> RITE_UNWEAVER = registerBlock("rite_unweaver", () -> new RiteUnweaverBlock(TWISTED_ROCK_TOTEMANCY()).setBlockEntity(MalumBlockEntities.RITE_UNWEAVER));
        public static final BlockBlockItemHolder<Block, BlockItem> RITE_SPREADER = registerBlock("rite_spreader", () -> new RiteSpreaderBlock(TAINTED_ROCK_TOTEMANCY()).setBlockEntity(MalumBlockEntities.RITE_SPREADER));
        public static final BlockBlockItemHolder<Block, BlockItem> RITE_CHANNEL = registerBlock("rite_channel", () -> new RiteChannelBlock(TAINTED_ROCK_TOTEMANCY()).setBlockEntity(MalumBlockEntities.RITE_CHANNEL));
    ...
    public static class Artifice {
        ...
        public static final DeferredItem<Item> ARTIFICERS_CLAW = register("artificers_claw", MalumItemProperties::GEAR_PROPERTIES, TinkeringToolItem::new);

        public static final BlockBlockItemHolder<Block, BlockItem> WAVECHARGER = registerBlock("wavecharger", () -> new WaveChargerBlock(WAVEFORM_DIODE()).setBlockEntity(MalumBlockEntities.WAVECHARGER));
        public static final BlockBlockItemHolder<Block, BlockItem> WAVEBANKER = registerBlock("wavebanker", () -> new WaveBankerBlock(WAVEFORM_DIODE()).setBlockEntity(MalumBlockEntities.WAVEBANKER));
        public static final BlockBlockItemHolder<Block, BlockItem> WAVEMAKER = registerBlock("wavemaker", () -> new WaveMakerBlock(WAVEFORM_DIODE()).setBlockEntity(MalumBlockEntities.WAVEMAKER));
        public static final BlockBlockItemHolder<Block, BlockItem> WAVEBREAKER = registerBlock("wavebreaker", () -> new WaveBreakerBlock(WAVEFORM_DIODE()).setBlockEntity(MalumBlockEntities.WAVEBREAKER));

        public static final BlockBlockItemHolder<Block, BlockItem> GUST_IGNITER = registerBlock("gust_igniter", () -> new GustIgniterBlock(GUST_TECH()).setBlockEntity(MalumBlockEntities.GUST_IGNITER));
        public static final BlockBlockItemHolder<Block, BlockItem> WIND_TUNNEL = registerBlock("wind_tunnel", () -> new WindTunnelBlock(GUST_TECH()).setBlockEntity(MalumBlockEntities.WIND_TUNNEL));

        public static final DeferredItem<Item> TUNING_FORK = register("tuning_fork", MalumItemProperties::GEAR_PROPERTIES, TinkeringToolItem::new);

        public static final BlockBlockItemHolder<Block, MultiBlockItem> SPIRIT_CRUCIBLE = registerMultiBlock("spirit_crucible", () -> new SpiritCrucibleCoreBlock<>(ARCANE_ROCK_ARTIFICE()).setBlockEntity(MalumBlockEntities.SPIRIT_CRUCIBLE), SpiritCrucibleCoreBlockEntity.STRUCTURE);
        ...
        public static final BlockBlockItemHolder<Block, MultiBlockItem> SPIRIT_CATALYZER = registerMultiBlock("spirit_catalyzer", () -> new SpiritCatalyzerCoreBlock<>(ARCANE_ROCK_ARTIFICE()).setBlockEntity(MalumBlockEntities.SPIRIT_CATALYZER), SpiritCatalyzerCoreBlockEntity.STRUCTURE);
        ...
        public static final BlockBlockItemHolder<Block, MultiBlockItem> REPAIR_PYLON = registerMultiBlock("repair_pylon", () -> new RepairPylonCoreBlock<>(ARCANE_ROCK_ARTIFICE()).setBlockEntity(MalumBlockEntities.REPAIR_PYLON), RepairPylonCoreBlockEntity.STRUCTURE);
        ...
        public static final DeferredItem<Item> ALCHEMICAL_IMPETUS = register("alchemical_impetus", MalumItemProperties::IMPETUS_PROPERTIES, ImpetusItem::new);
        public static final DeferredItem<Item> FRACTURED_ALCHEMICAL_IMPETUS = register("fractured_alchemical_impetus", MalumItemProperties::IMPETUS_PROPERTIES, FracturedImpetusItem::new);

        public static final DeferredItem<Item> ZEPHYR_IMPETUS = register("zephyr_impetus", MalumItemProperties::IMPETUS_PROPERTIES, ImpetusItem::new);
        public static final DeferredItem<Item> FRACTURED_ZEPHYR_IMPETUS = register("fractured_zephyr_impetus", MalumItemProperties::IMPETUS_PROPERTIES, FracturedImpetusItem::new);

        public static final DeferredItem<Item> IFRIT_IMPETUS = register("ifrit_impetus", MalumItemProperties::IMPETUS_PROPERTIES, ImpetusItem::new);
        public static final DeferredItem<Item> FRACTURED_IFRIT_IMPETUS = register("fractured_ifrit_impetus", MalumItemProperties::IMPETUS_PROPERTIES, FracturedImpetusItem::new);
        ...
        public static final DeferredItem<Item> MENDING_DIFFUSER = register("mending_diffuser", MalumItemProperties::DEFAULT_PROPERTIES, MendingDiffuserItem::new);
        public static final DeferredItem<Item> IMPURITY_STABILIZER = register("impurity_stabilizer", MalumItemProperties::DEFAULT_PROPERTIES, ImpurityStabilizer::new);
        public static final DeferredItem<Item> SHIELDING_APPARATUS = register("shielding_apparatus", MalumItemProperties::DEFAULT_PROPERTIES, ShieldingApparatusItem::new);
        public static final DeferredItem<Item> WARPING_ENGINE = register("warping_engine", MalumItemProperties::DEFAULT_PROPERTIES, WarpingEngineItem::new);

        public static final DeferredItem<Item> ACCELERATING_INLAY = register("accelerating_inlay", MalumItemProperties::DEFAULT_PROPERTIES, AcceleratingInlayItem::new);
        public static final DeferredItem<Item> PRISMATIC_FOCUS_LENS = register("prismatic_focus_lens", MalumItemProperties::DEFAULT_PROPERTIES, PrismaticFocusLensItem::new);
        public static final DeferredItem<Item> BLAZING_DIODE = register("blazing_diode", MalumItemProperties::DEFAULT_PROPERTIES, BlazingDiodeItem::new);
        public static final DeferredItem<Item> INTRICATE_ASSEMBLY = register("intricate_assembly", MalumItemProperties::DEFAULT_PROPERTIES, IntricateAssemblyItem::new);

        public static final DeferredItem<Item> SYMPATHY_DRIVE = register("sympathy_drive", MalumItemProperties::DEFAULT_PROPERTIES, SympathyDrive::new);
        public static final DeferredItem<Item> SUSPICIOUS_DEVICE = register("suspicious_device", MalumItemProperties::DEFAULT_PROPERTIES, SuspiciousDeviceItem::new);
        public static final DeferredItem<Item> CAUSTIC_CATALYST = register("caustic_catalyst", MalumItemProperties::DEFAULT_PROPERTIES, CausticCatalystItem::new);
        public static final DeferredItem<Item> RESONANCE_TUNER = register("resonance_tuner", MalumItemProperties::DEFAULT_PROPERTIES, ResonanceTuner::new);

        public static final DeferredItem<Item> STELLAR_MECHANISM = register("stellar_mechanism", MalumItemProperties::DEFAULT_PROPERTIES, StellarMechanismItem::new);
    ...
    public static class Progression {
        ...
        public static final BlockBlockItemHolder<Block, BlockItem> SPIRIT_ALTAR = registerBlock("spirit_altar", () -> new SpiritAltarBlock<>(SPIRIT_ALTAR()).setBlockEntity(MalumBlockEntities.SPIRIT_ALTAR));
        public static final BlockBlockItemHolder<Block, BlockItem> SOUL_BRAZIER = registerBlock("soulbinding_brazier", () -> new SoulBrazierBlock<>(SOUL_BRAZIER()).setBlockEntity(MalumBlockEntities.SOUL_BRAZIER));

        public static final BlockBlockItemHolder<Block, BlockItem> SPIRIT_JAR = registerBlock("spirit_jar", () -> new SpiritJarBlock<>(SPIRIT_JAR().setCutoutRenderType().noOcclusion()).setBlockEntity(MalumBlockEntities.SPIRIT_JAR));

        public static final BlockBlockItemHolder<Block, BlockItem> WEAVERS_WORKBENCH = registerBlock("weavers_workbench", () -> new WeaversWorkbenchBlock<>(RUNEWOOD().setCutoutRenderType().noOcclusion()).setBlockEntity(MalumBlockEntities.WEAVERS_WORKBENCH));
        public static final BlockBlockItemHolder<Block, BlockItem> RUNIC_WORKBENCH = registerBlock("runic_workbench", () -> new RunicWorkbenchBlock<>(RUNEWOOD().setCutoutRenderType().noOcclusion()).setBlockEntity(MalumBlockEntities.RUNIC_WORKBENCH));

        public static final BlockBlockItemHolder<Block, BlockItem> RITUAL_PLINTH = registerBlock("ritual_plinth", () -> new RitualPlinthBlock<>(SOULWOOD().setCutoutRenderType().noOcclusion()).setBlockEntity(MalumBlockEntities.RITUAL_PLINTH));

        public static final BlockBlockItemHolder<Block, MultiBlockItem> RUNEWOOD_OBELISK = registerMultiBlock("runewood_obelisk", () -> new RunewoodObeliskCoreBlock(RUNEWOOD().setCutoutRenderType().noOcclusion()), RunewoodObeliskBlockEntity.STRUCTURE);
        public static final DeferredHolder<Block, ObeliskComponentBlock> RUNEWOOD_OBELISK_COMPONENT = registerBlockNoItem("runewood_obelisk_component", () -> new ObeliskComponentBlock(RUNEWOOD().setCutoutRenderType().lootFrom(RUNEWOOD_OBELISK).noOcclusion()));

        public static final BlockBlockItemHolder<Block, MultiBlockItem> BRILLIANT_OBELISK = registerMultiBlock("brilliant_obelisk", () -> new BrillianceObeliskCoreBlock(RUNEWOOD().setCutoutRenderType().noOcclusion()), BrilliantObeliskBlockEntity.STRUCTURE);
        public static final DeferredHolder<Block, ObeliskComponentBlock> BRILLIANT_OBELISK_COMPONENT = registerBlockNoItem("brilliant_obelisk_component", () -> new ObeliskComponentBlock(RUNEWOOD().setCutoutRenderType().lootFrom(BRILLIANT_OBELISK).noOcclusion()));

        public static final BlockBlockItemHolder<Block, MultiBlockItem> ARCANA_PYLON = registerMultiBlock("arcana_pylon", () -> new ArcanaPylonCoreBlock(SOULWOOD().setCutoutRenderType().noOcclusion()), ArcanaPylonBlockEntity.STRUCTURE);
        public static final DeferredHolder<Block, ArcanaPylonComponentBlock> ARCANA_PYLON_COMPONENT = registerBlockNoItem("arcana_pylon_component", () -> new ArcanaPylonComponentBlock(SOULWOOD().setCutoutRenderType().lootFrom(ARCANA_PYLON).noOcclusion()));

        public static final DeferredBlock<Block> SPIRIT_MOTE = registerBlockNoItem("spirit_mote", () -> new ManaMoteBlock(MalumStorageBlockProperties.MANA_MOTE_BLOCK()).setBlockEntity(MalumBlockEntities.MANA_MOTE));
    ...
    public static class DungeonBlockSets {
        ...
        public static final DeferredBlock<Block> OMINOUS_OBELISK_COMPONENT = registerBlockNoItem("ominous_obelisk_component", () -> new ObeliskComponentBlock(MalumDungeonBlockProperties.OMINOUS_CRAFT().setCutoutRenderType().lootFrom(OMINOUS_OBELISK).noOcclusion()));
    ...
    public static class WeepingWell {
        ...
        public static final BlockBlockItemHolder<Block, BlockItem> VOID_CONDUIT = registerBlock("void_conduit", () -> new VoidConduitBlock<>(PRIMORDIAL_SOUP()).setBlockEntity(MalumBlockEntities.VOID_CONDUIT));
        ...
        public static final BlockBlockItemHolder<Block, BlockItem> VOID_DEPOT = registerBlock("void_depot", () -> new VoidDepotBlock<>(WEEPING_WELL()).setBlockEntity(MalumBlockEntities.VOID_DEPOT));
    ...
    public static <T extends Block> BlockBlockItemHolder<T, BlockItem> registerEtherBlock(String name, Supplier<T> supplier) {
        return registerBlock(name, name, supplier, EtherItem::ether);
    }

    public static <T extends Block> BlockBlockItemHolder<T, BlockItem> registerEtherIridescentBlock(String name, Supplier<T> supplier) {
        return registerBlock(name, name, supplier, EtherItem::iridescent);
    }
    ...
    public static <T extends Block, K extends BlockItem> BlockBlockItemHolder<T, K> registerBlock(String blockName, String itemName, Supplier<T> blockSupplier, BiFunction<Block, LodestoneItemProperties, K> itemSupplier) {
        ...
        var item = register(itemName, MalumItemProperties::DEFAULT_PROPERTIES, p -> itemSupplier.apply(block.get(), p));
