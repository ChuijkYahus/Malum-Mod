...
public class MalumBlockEntities {
    ...
    public static final Supplier<LodestoneBlockEntityType<VoidConduitBlockEntity>> VOID_CONDUIT = BLOCK_ENTITY_TYPES.register("void_conduit", () -> LodestoneBlockEntityTypeBuilder.of(VoidConduitBlockEntity::new, MalumContent.Progression.VOID_CONDUIT.get()).setTickerType(Type.BOTH).build());
    public static final Supplier<LodestoneBlockEntityType<VoidDepotBlockEntity>> VOID_DEPOT = BLOCK_ENTITY_TYPES.register("void_depot", () -> LodestoneBlockEntityTypeBuilder.of(VoidDepotBlockEntity::new, MalumContent.Progression.VOID_DEPOT.get()).setTickerType(Type.CLIENT).build());

    public static final Supplier<LodestoneBlockEntityType<SpiritAltarBlockEntity>> SPIRIT_ALTAR = BLOCK_ENTITY_TYPES.register("spirit_altar", () -> LodestoneBlockEntityTypeBuilder.of(SpiritAltarBlockEntity::new, MalumContent.Progression.SPIRIT_ALTAR.get()).setTickerType(Type.BOTH).build());
    public static final Supplier<LodestoneBlockEntityType<SpiritJarBlockEntity>> SPIRIT_JAR = BLOCK_ENTITY_TYPES.register("spirit_jar", () -> LodestoneBlockEntityTypeBuilder.of(SpiritJarBlockEntity::new, MalumContent.Progression.SPIRIT_JAR.get()).setTickerType(Type.CLIENT).build());

    public static final Supplier<LodestoneBlockEntityType<RunicWorkbenchBlockEntity>> RUNIC_WORKBENCH = BLOCK_ENTITY_TYPES.register("runic_workbench", () -> LodestoneBlockEntityTypeBuilder.of(RunicWorkbenchBlockEntity::new, MalumContent.Progression.RUNIC_WORKBENCH.get()).setTickerType(Type.SERVER).build());
    public static final Supplier<LodestoneBlockEntityType<WeaversWorkbenchBlockEntity>> WEAVERS_WORKBENCH = BLOCK_ENTITY_TYPES.register("weavers_workbench", () -> LodestoneBlockEntityTypeBuilder.of(WeaversWorkbenchBlockEntity::new, MalumContent.Progression.WEAVERS_WORKBENCH.get()).build());

    public static final Supplier<LodestoneBlockEntityType<SoulBrazierBlockEntity>> SOUL_BRAZIER = BLOCK_ENTITY_TYPES.register("soulbinding_brazier", () -> LodestoneBlockEntityTypeBuilder.of(SoulBrazierBlockEntity::new, MalumContent.Progression.SOUL_BRAZIER.get()).setTickerType(Type.BOTH).build());

    public static final Supplier<LodestoneBlockEntityType<RunewoodObeliskBlockEntity>> RUNEWOOD_OBELISK = BLOCK_ENTITY_TYPES.register("runewood_obelisk", () -> LodestoneBlockEntityTypeBuilder.of(RunewoodObeliskBlockEntity::new, MalumContent.Progression.RUNEWOOD_OBELISK.get()).build());
    public static final Supplier<LodestoneBlockEntityType<BrilliantObeliskBlockEntity>> BRILLIANT_OBELISK = BLOCK_ENTITY_TYPES.register("brilliant_obelisk", () -> LodestoneBlockEntityTypeBuilder.of(BrilliantObeliskBlockEntity::new, MalumContent.Progression.BRILLIANT_OBELISK.get()).build());
    public static final Supplier<LodestoneBlockEntityType<ArcanaPylonBlockEntity>> ARCANA_PYLON = BLOCK_ENTITY_TYPES.register("arcana_pylon", () -> LodestoneBlockEntityTypeBuilder.of(ArcanaPylonBlockEntity::new, MalumContent.Progression.ARCANA_PYLON.get()).setTickerType(Type.BOTH).build());

    //TODO: Automate this what-block-does-a-block-entity-need definition process

    public static final Supplier<LodestoneBlockEntityType<SpiritCrucibleCoreBlockEntity>> SPIRIT_CRUCIBLE = BLOCK_ENTITY_TYPES.register("spirit_crucible", () -> LodestoneBlockEntityTypeBuilder.of(SpiritCrucibleCoreBlockEntity::new, MalumContent.Artifice.SPIRIT_CRUCIBLE.get()).setTickerType(Type.BOTH).build());
    public static final Supplier<LodestoneBlockEntityType<SpiritCatalyzerCoreBlockEntity>> SPIRIT_CATALYZER = BLOCK_ENTITY_TYPES.register("spirit_catalyzer", () -> LodestoneBlockEntityTypeBuilder.of(SpiritCatalyzerCoreBlockEntity::new, MalumContent.Artifice.SPIRIT_CATALYZER.get()).setTickerType(Type.BOTH).build());
    public static final Supplier<LodestoneBlockEntityType<RepairPylonCoreBlockEntity>> REPAIR_PYLON = BLOCK_ENTITY_TYPES.register("repair_pylon", () -> LodestoneBlockEntityTypeBuilder.of(RepairPylonCoreBlockEntity::new, MalumContent.Artifice.REPAIR_PYLON.get()).setTickerType(Type.BOTH).build());

    public static final Supplier<LodestoneBlockEntityType<EtherBlockEntity>> ETHER = BLOCK_ENTITY_TYPES.register("ether", () -> LodestoneBlockEntityTypeBuilder.of(EtherBlockEntity::new, MalumContent.BlockSets.ETHER.get(), MalumContent.BlockSets.IRIDESCENT_ETHER.get()).setTickerType(Type.CLIENT).build());
    public static final Supplier<LodestoneBlockEntityType<EtherCandleBlockEntity>> ETHER_CANDLE = BLOCK_ENTITY_TYPES.register("ether_candle", () -> LodestoneBlockEntityTypeBuilder.of(EtherCandleBlockEntity::new, MalumContent.BlockSets.ETHER_CANDLE.get(), MalumContent.BlockSets.IRIDESCENT_ETHER_CANDLE.get()).setTickerType(Type.CLIENT).build());
    ...
    public static final Supplier<LodestoneBlockEntityType<TotemPoleBlockEntity>> TOTEM_POLE = BLOCK_ENTITY_TYPES.register("totem_pole", () -> LodestoneBlockEntityTypeBuilder.of(TotemPoleBlockEntity::new, MalumContent.Totemancy.RUNEWOOD_TOTEM_POLE.get(), MalumContent.Totemancy.SOULWOOD_TOTEM_POLE.get()).setTickerType(Type.BOTH).build());
    ...
    public static final Supplier<LodestoneBlockEntityType<RiteAnchorBlockEntity>> RITE_ANCHOR = BLOCK_ENTITY_TYPES.register("rite_anchor", () -> LodestoneBlockEntityTypeBuilder.of(RiteAnchorBlockEntity::new, MalumContent.Totemancy.RITE_ANCHOR.get()).setTickerType(Type.BOTH).build());
    public static final Supplier<LodestoneBlockEntityType<RiteUnweaverBlockEntity>> RITE_UNWEAVER = BLOCK_ENTITY_TYPES.register("rite_unweaver", () -> LodestoneBlockEntityTypeBuilder.of(RiteUnweaverBlockEntity::new, MalumContent.Totemancy.RITE_UNWEAVER.get()).build());
    public static final Supplier<LodestoneBlockEntityType<RiteSpreaderBlockEntity>> RITE_SPREADER = BLOCK_ENTITY_TYPES.register("rite_spreader", () -> LodestoneBlockEntityTypeBuilder.of(RiteSpreaderBlockEntity::new, MalumContent.Totemancy.RITE_SPREADER.get()).build());
    public static final Supplier<LodestoneBlockEntityType<RiteChannelBlockEntity>> RITE_CHANNEL = BLOCK_ENTITY_TYPES.register("rite_channel", () -> LodestoneBlockEntityTypeBuilder.of(RiteChannelBlockEntity::new, MalumContent.Totemancy.RITE_CHANNEL.get()).build());
    ...
    public static final Supplier<LodestoneBlockEntityType<GustIgniterBlockEntity>> GUST_IGNITER = BLOCK_ENTITY_TYPES.register("gust_igniter", () -> LodestoneBlockEntityTypeBuilder.of(GustIgniterBlockEntity::new, MalumContent.Progression.GUST_IGNITER.get()).setTickerType(Type.SERVER).build());
    public static final Supplier<LodestoneBlockEntityType<WindTunnelBlockEntity>> WIND_TUNNEL = BLOCK_ENTITY_TYPES.register("wind_tunnel", () -> LodestoneBlockEntityTypeBuilder.of(WindTunnelBlockEntity::new, MalumContent.Progression.WIND_TUNNEL.get()).build());

    public static final Supplier<LodestoneBlockEntityType<OminousAltarBlockEntity>> OMINOUS_ALTAR = BLOCK_ENTITY_TYPES.register("ominous_altar", () -> LodestoneBlockEntityTypeBuilder.of(OminousAltarBlockEntity::new, MalumContent.DungeonBlockSets.OMINOUS_ALTAR.get()).setTickerType(Type.BOTH).build());
    public static final Supplier<LodestoneBlockEntityType<OminousObeliskBlockEntity>> OMINOUS_OBELISK = BLOCK_ENTITY_TYPES.register("ominous_obelisk", () -> LodestoneBlockEntityTypeBuilder.of(OminousObeliskBlockEntity::new, MalumContent.DungeonBlockSets.OMINOUS_OBELISK.get()).setTickerType(Type.BOTH).build());

    public static final Supplier<LodestoneBlockEntityType<RitualPlinthBlockEntity>> RITUAL_PLINTH = BLOCK_ENTITY_TYPES.register("ritual_plinth", () -> LodestoneBlockEntityTypeBuilder.of(RitualPlinthBlockEntity::new, MalumContent.Progression.RITUAL_PLINTH.get()).build());
