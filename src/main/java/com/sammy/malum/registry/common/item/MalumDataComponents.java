...
public class MalumDataComponents {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<VindictiveBrandDataComponent>> VINDICTIVE_BRAND_UNLEASHED = register("vindictive_brand_state", builder ->
            builder.persistent(VindictiveBrandDataComponent.CODEC).networkSynchronized(VindictiveBrandDataComponent.STREAM_CODEC));
