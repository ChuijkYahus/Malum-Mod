...
public class MalumBlockEntities {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<EtherCandleBlockEntity>> ETHER_CANDLE = BLOCK_ENTITY_TYPES.register("ether_candle", () -> BlockEntityType.Builder.of(EtherCandleBlockEntity::new, MalumBlocks.ETHER_CANDLE.get(), MalumBlocks.IRIDESCENT_ETHER_CANDLE.get()).build(null));
