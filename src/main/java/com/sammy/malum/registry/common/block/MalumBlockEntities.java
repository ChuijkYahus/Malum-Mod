...
public class MalumBlockEntities {
    ...
    public static final Supplier<LodestoneBlockEntityType<VoidConduitBlockEntity>> VOID_CONDUIT = BLOCK_ENTITY_TYPES.register("void_conduit", () -> LodestoneBlockEntityTypeBuilder.of(VoidConduitBlockEntity::new, MalumContent.WeepingWell.VOID_CONDUIT.get()).setTickerType(Type.BOTH).build());
    public static final Supplier<LodestoneBlockEntityType<VoidDepotBlockEntity>> VOID_DEPOT = BLOCK_ENTITY_TYPES.register("void_depot", () -> LodestoneBlockEntityTypeBuilder.of(VoidDepotBlockEntity::new, MalumContent.WeepingWell.VOID_DEPOT.get()).setTickerType(Type.CLIENT).build());
    ...
    public static final Supplier<LodestoneBlockEntityType<GustIgniterBlockEntity>> GUST_IGNITER = BLOCK_ENTITY_TYPES.register("gust_igniter", () -> LodestoneBlockEntityTypeBuilder.of(GustIgniterBlockEntity::new, MalumContent.Artifice.GUST_IGNITER.get()).setTickerType(Type.SERVER).build());
    public static final Supplier<LodestoneBlockEntityType<WindTunnelBlockEntity>> WIND_TUNNEL = BLOCK_ENTITY_TYPES.register("wind_tunnel", () -> LodestoneBlockEntityTypeBuilder.of(WindTunnelBlockEntity::new, MalumContent.Artifice.WIND_TUNNEL.get()).build());
