...
public class MalumBlockEntities {
    ...
    public static final Supplier<LodestoneBlockEntityType<VoidConduitBlockEntity>> VOID_CONDUIT = BLOCK_ENTITY_TYPES.register("void_conduit", () -> LodestoneBlockEntityTypeBuilder.of(VoidConduitBlockEntity::new, MalumBlocks.VOID_CONDUIT.get()).build());
    public static final Supplier<LodestoneBlockEntityType<VoidDepotBlockEntity>> VOID_DEPOT = BLOCK_ENTITY_TYPES.register("void_depot", () -> LodestoneBlockEntityTypeBuilder.of(VoidDepotBlockEntity::new, MalumBlocks.VOID_DEPOT.get()).build());

    public static final Supplier<LodestoneBlockEntityType<SpiritAltarBlockEntity>> SPIRIT_ALTAR = BLOCK_ENTITY_TYPES.register("spirit_altar", () -> LodestoneBlockEntityTypeBuilder.of(SpiritAltarBlockEntity::new, MalumBlocks.SPIRIT_ALTAR.get()).build());
    public static final Supplier<LodestoneBlockEntityType<SpiritJarBlockEntity>> SPIRIT_JAR = BLOCK_ENTITY_TYPES.register("spirit_jar", () -> LodestoneBlockEntityTypeBuilder.of(SpiritJarBlockEntity::new, MalumBlocks.SPIRIT_JAR.get()).build());
    ...
    public static final Supplier<LodestoneBlockEntityType<SoulBrazierBlockEntity>> SOUL_BRAZIER = BLOCK_ENTITY_TYPES.register("soulbinding_brazier", () -> LodestoneBlockEntityTypeBuilder.of(SoulBrazierBlockEntity::new, MalumBlocks.SOUL_BRAZIER.get()).build());
    ...
    public static final Supplier<LodestoneBlockEntityType<ArcanaPylonBlockEntity>> ARCANA_PYLON = BLOCK_ENTITY_TYPES.register("arcana_pylon", () -> LodestoneBlockEntityTypeBuilder.of(ArcanaPylonBlockEntity::new, MalumBlocks.ARCANA_PYLON.get()).build());

    public static final Supplier<LodestoneBlockEntityType<SpiritCrucibleCoreBlockEntity>> SPIRIT_CRUCIBLE = BLOCK_ENTITY_TYPES.register("spirit_crucible", () -> LodestoneBlockEntityTypeBuilder.of(SpiritCrucibleCoreBlockEntity::new, MalumBlocks.SPIRIT_CRUCIBLE.get()).build());
    public static final Supplier<LodestoneBlockEntityType<SpiritCatalyzerCoreBlockEntity>> SPIRIT_CATALYZER = BLOCK_ENTITY_TYPES.register("spirit_catalyzer", () -> LodestoneBlockEntityTypeBuilder.of(SpiritCatalyzerCoreBlockEntity::new, MalumBlocks.SPIRIT_CATALYZER.get()).build());
    public static final Supplier<LodestoneBlockEntityType<RepairPylonCoreBlockEntity>> REPAIR_PYLON = BLOCK_ENTITY_TYPES.register("repair_pylon", () -> LodestoneBlockEntityTypeBuilder.of(RepairPylonCoreBlockEntity::new, MalumBlocks.REPAIR_PYLON.get()).build());

    public static final Supplier<LodestoneBlockEntityType<EtherBlockEntity>> ETHER = BLOCK_ENTITY_TYPES.register("ether", () -> LodestoneBlockEntityTypeBuilder.of(EtherBlockEntity::new, MalumBlocks.ETHER.get(), MalumBlocks.IRIDESCENT_ETHER.get()).build());
    public static final Supplier<LodestoneBlockEntityType<EtherCandleBlockEntity>> ETHER_CANDLE = BLOCK_ENTITY_TYPES.register("ether_candle", () -> LodestoneBlockEntityTypeBuilder.of(EtherCandleBlockEntity::new, MalumBlocks.ETHER_CANDLE.get(), MalumBlocks.IRIDESCENT_ETHER_CANDLE.get()).build());
    public static final Supplier<LodestoneBlockEntityType<EtherTorchBlockEntity>> ETHER_TORCH = BLOCK_ENTITY_TYPES.register("ether_torch", () -> LodestoneBlockEntityTypeBuilder.of(EtherTorchBlockEntity::new, getBlocks(EtherTorchBlock.class, EtherWallTorchBlock.class)).build());
    public static final Supplier<LodestoneBlockEntityType<EtherBrazierBlockEntity>> ETHER_BRAZIER = BLOCK_ENTITY_TYPES.register("ether_brazier", () -> LodestoneBlockEntityTypeBuilder.of(EtherBrazierBlockEntity::new, getBlocks(EtherBrazierBlock.class)).build());
    public static final Supplier<LodestoneBlockEntityType<EtherCressetBlockEntity>> ETHER_CRESSET = BLOCK_ENTITY_TYPES.register("ether_cresset", () -> LodestoneBlockEntityTypeBuilder.of(EtherCressetBlockEntity::new, getBlocks(EtherCressetBlock.class)).build());

    public static final Supplier<LodestoneBlockEntityType<ItemStandBlockEntity>> ITEM_STAND = BLOCK_ENTITY_TYPES.register("item_stand", () -> LodestoneBlockEntityTypeBuilder.of(ItemStandBlockEntity::new, getBlocks(ItemStandBlock.class)).build());
    public static final Supplier<LodestoneBlockEntityType<ItemPedestalBlockEntity>> ITEM_PEDESTAL = BLOCK_ENTITY_TYPES.register("item_pedestal", () -> LodestoneBlockEntityTypeBuilder.of(ItemPedestalBlockEntity::new, getBlocks(ItemPedestalBlock.class)).build());

    public static final Supplier<LodestoneBlockEntityType<TotemPoleBlockEntity>> TOTEM_POLE = BLOCK_ENTITY_TYPES.register("totem_pole", () -> LodestoneBlockEntityTypeBuilder.of(TotemPoleBlockEntity::new, MalumBlocks.RUNEWOOD_TOTEM_POLE.get(), MalumBlocks.SOULWOOD_TOTEM_POLE.get()).build());
    public static final Supplier<LodestoneBlockEntityType<TotemBaseBlockEntity>> TOTEM_BASE = BLOCK_ENTITY_TYPES.register("totem_base", () -> LodestoneBlockEntityTypeBuilder.of(TotemBaseBlockEntity::new, getBlocks(TotemBaseBlock.class)).build());
    public static final Supplier<LodestoneBlockEntityType<WaveformTotemBaseBlockEntity>> WAVEFORM_TOTEM_BASE = BLOCK_ENTITY_TYPES.register("waveform_totem_base", () -> LodestoneBlockEntityTypeBuilder.of(WaveformTotemBaseBlockEntity::new, getBlocks(WaveformTotemBaseBlock.class)).build());

    public static final Supplier<LodestoneBlockEntityType<RiteAnchorBlockEntity>> RITE_ANCHOR = BLOCK_ENTITY_TYPES.register("rite_anchor", () -> LodestoneBlockEntityTypeBuilder.of(RiteAnchorBlockEntity::new, MalumBlocks.RITE_ANCHOR.get()).build());
    ...
    public static final Supplier<LodestoneBlockEntityType<GustIgniterBlockEntity>> GUST_IGNITER = BLOCK_ENTITY_TYPES.register("gust_igniter", () -> LodestoneBlockEntityTypeBuilder.of(GustIgniterBlockEntity::new, MalumBlocks.GUST_IGNITER.get()).build());
    ...
    public static final Supplier<LodestoneBlockEntityType<OminousAltarBlockEntity>> OMINOUS_ALTAR = BLOCK_ENTITY_TYPES.register("ominous_altar", () -> LodestoneBlockEntityTypeBuilder.of(OminousAltarBlockEntity::new, MalumBlocks.OMINOUS_ALTAR.get()).build());
    public static final Supplier<LodestoneBlockEntityType<OminousObeliskBlockEntity>> OMINOUS_OBELISK = BLOCK_ENTITY_TYPES.register("ominous_obelisk", () -> LodestoneBlockEntityTypeBuilder.of(OminousObeliskBlockEntity::new, MalumBlocks.OMINOUS_OBELISK.get()).build());
