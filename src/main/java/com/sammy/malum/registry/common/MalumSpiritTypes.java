...
public class MalumSpiritTypes {
    ...
    private static SpiritColorProperties SACRED_COLORS() {
    ...
    private static SpiritColorProperties WICKED_COLORS() {
    ...
    private static SpiritColorProperties ARCANE_COLORS() {
    ...
    private static SpiritColorProperties ELDRITCH_COLORS() {
    ...
    private static SpiritColorProperties AERIAL_COLORS() {
    ...
    private static SpiritColorProperties AQUEOUS_COLORS() {
    ...
    private static SpiritColorProperties EARTHEN_COLORS() {
    ...
    private static SpiritColorProperties INFERNAL_COLORS() {
    ...
    private static SpiritColorProperties UMBRAL_COLORS() {
    ...
    public static final SpiritHolder<MalumSpiritType> UMBRAL_SPIRIT = SPIRIT_TYPES.register("infernal", () -> new UmbralSpiritType(UMBRAL_COLORS(), MalumItems.UMBRAL_SPIRIT));
}