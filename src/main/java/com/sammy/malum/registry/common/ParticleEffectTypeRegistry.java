...
public class ParticleEffectTypeRegistry {
    ...
    //Blight vfx
    public static final NetworkedParticleEffectType BLIGHTING_MIST = new BlightingMistParticleEffect("blighting_mist");

    //Spirit Altar
    public static final NetworkedParticleEffectType SPIRIT_ALTAR_CRAFTS = new SpiritAltarCraftParticleEffect("spirit_altar_crafts");
    ...
    //Crucible
    public static final NetworkedParticleEffectType SPIRIT_CRUCIBLE_CRAFTS = new SpiritCrucibleCraftParticleEffect("spirit_crucible_crafts");
    public static final NetworkedParticleEffectType SUSPICIOUS_DEVICE_PRIMER = new SuspiciousDevicePrimerParticleEffect("suspicious_device_primer");

    //Repair Pylon
    public static final NetworkedParticleEffectType REPAIR_PYLON_PREPARES = new PylonPrepareRepairParticleEffect("repair_pylon_prepare");
    public static final NetworkedParticleEffectType REPAIR_PYLON_REPAIRS = new PylonRepairParticleEffect("repair_pylon_repairs");
    ...
    //Spirit Diode
    public static final NetworkedParticleEffectType SPIRIT_DIODE_OPEN = new SpiritDiodeOpenParticleEffect("spirit_diode_open");
    ...
    public static final NetworkedParticleEffectType TYRVING_SLASH = new TyrvingSlashParticleEffect("tyrving_slash");
    public static final NetworkedParticleEffectType SUNDERING_ANCHOR_SLASH = new SunderingAnchorSlashParticleEffect("sundering_anchor_slash");
    public static final NetworkedParticleEffectType SUNDERING_ANCHOR_SWEEP = new SunderingAnchorSweepParticleEffect("sundering_anchor_sweep");

    public static final NetworkedParticleEffectType WEIGHT_OF_WORLDS_CRIT = new WeightOfWorldsCritParticleEffect("weight_of_worlds_crit");
    public static final NetworkedParticleEffectType EDGE_OF_DELIVERANCE_CRIT = new EdgeOfDeliveranceCritParticleEffect("weight_of_worlds_crit");
    ...
    public static final NetworkedParticleEffectType INVERTED_HEART_IMPACT = new InvertedHeartGeasImpactParticleEffect("inverted_heart_impact");
    public static final NetworkedParticleEffectType WYRD_RECONSTRUCTION_REVIVE = new WyrdReconstructionReviveParticleEffect("wyrd_reconstruction_revive");

    //Gluttony
    public static final NetworkedParticleEffectType THROWN_GLUTTONY_IMPACT = new ThrownGluttonyParticleEffect("splash_of_gluttony");
    public static final NetworkedParticleEffectType GLUTTONY_ABSORB = new AbsorbGluttonyParticleEffect("gluttony_absorbed");
