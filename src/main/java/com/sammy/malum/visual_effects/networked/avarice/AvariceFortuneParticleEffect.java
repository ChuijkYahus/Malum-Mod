...
public class AvariceFortuneParticleEffect extends MalumNetworkedParticleEffectType<NetworkedParticleEffectExtraData> {

    public AvariceFortuneParticleEffect(String id) {
        super(id);
    }
    ...
    public void act(Level level, RandomSource random, NetworkedParticleEffectPositionData positionData, MalumNetworkedParticleEffectColorData colorData, NetworkedParticleEffectExtraData extraData) {
        AvariceParticleEffects.avariceFortuneBlockEffect(level, colorData, positionData.getAsVector());
    }
}