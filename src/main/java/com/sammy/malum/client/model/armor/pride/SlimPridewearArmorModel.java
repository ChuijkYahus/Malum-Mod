...
public class SlimPridewearArmorModel extends LodestoneArmorModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition left_shoulder = left_arm.addOrReplaceChild("left_arm_armor", CubeListBuilder.create().texOffs(32, 32).addBox(1.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.525F))
