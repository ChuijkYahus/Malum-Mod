package com.sammy.malum.client.model.armor.pride;
...
public class PridewearArmorModel extends LodestoneArmorModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition torso = body.addOrReplaceChild("body_armor", CubeListBuilder.create().texOffs(16, 0).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.525F))
                .texOffs(16, 16).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.75F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition leggings = root.getChild("waist");
        PartDefinition codpiece = leggings.addOrReplaceChild("waist_armor", CubeListBuilder.create().texOffs(0, 56).addBox(-5.0F, -14.0F, -3.0F, 10.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24f, 0.0F));

        PartDefinition right_legging = root.getChild("right_leg");
        PartDefinition right_leg = right_legging.addOrReplaceChild("right_leg_armor", CubeListBuilder.create().texOffs(0, 48).addBox(-1.9F, 0.0F, -2.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.625F))
        ...
        PartDefinition right_boot = right_foot.addOrReplaceChild("right_foot_armor", CubeListBuilder.create().texOffs(0, 4).addBox(-1.9F, 4.0F, -2.0F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.625F))
        ...
        PartDefinition right_shoulder = right_arm.addOrReplaceChild("right_arm_armor", CubeListBuilder.create().texOffs(40, 0).addBox(-5.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.525F))
                .texOffs(40, 16).addBox(-5.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.75F)), PartPose.offset(2, 0, 0.0F));

        PartDefinition left_legging = root.getChild("left_leg");
        PartDefinition left_leg = left_legging.addOrReplaceChild("left_leg_armor", CubeListBuilder.create().texOffs(32, 48).addBox(-2.1F, 0.0F, -2.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.625F))
        ...
        PartDefinition left_boot = left_foot.addOrReplaceChild("left_foot_armor", CubeListBuilder.create().texOffs(16, 36).addBox(-2.1F, 4.0F, -2.0F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.625F))
        ...
        PartDefinition left_shoulder = left_arm.addOrReplaceChild("left_arm_armor", CubeListBuilder.create().texOffs(32, 32).addBox(1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.525F))
                .texOffs(48, 32).addBox(1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.75F)), PartPose.offset(-2, 0, 0.0F));

        PartDefinition head = root.getChild("head");
        PartDefinition beanie = head.addOrReplaceChild("head_armor", CubeListBuilder.create().texOffs(100, 60).addBox(-1.5F, -33.3512F, -8.053F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.2F))
