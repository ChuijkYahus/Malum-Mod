//package com.sammy.malum.client.screen.codex.old;
//
...
//
////        BookChapter introduction = new BookChapter();
////
////        introduction.addEntry("introduction", 0, 0)
...
////                .addRightReference(new EntryBookmark(CodexCommons.HEX_ASH,
////                        BookEntry.create("common_reagents.hex_ash")
////                                .addPage(headlineTextGizmoPage("common_reagents.hex_ash", CodexCommons.HEX_ASH))
////                ))
////                .addRightReference(new EntryBookmark(CodexCommons.LIVING_FLESH,
...
////                ))
////                .addRightReference(new EntryBookmark(CodexCommons.ALCHEMICAL_CALX,
...
////                .addRightReference(new EntryBookmark(CodexCommons.GRIM_TALC,
...
////                ))
////                .addRightReference(new EntryBookmark(CodexCommons.ROTTING_ESSENCE,
...
////                ))
////                .addRightReference(new EntryBookmark(CodexCommons.EERIE_WEAVE,
...
////                ))
////                .addRightReference(new EntryBookmark(CodexCommons.WARP_FLUX,
...
////                ))
////
////                .addLeftReference(new EntryBookmark(CodexCommons.CORE_KEEPING,
...
////                                .addRightReference(new EntryBookmark(CodexCommons.WIND_NUCLEUS,
...
////                                ))
////                                .addRightReference(new EntryBookmark(CodexCommons.PYRE_NUCLEUS,
...
////                .configureWidget(w -> w.setIcon(CodexCommons.ARCANE_SPIRIT).setDesign(SMALL, RUNEWOOD, DARK))
////                .setWidgetSupplier(spiritSubspace())
...
//    }
//
////    public static SubspaceEntryObject.SubspaceBookObjectBuilder spiritSubspace() {
////        var spiritSubspace = new SubspaceEntryObject.SubspaceBookObjectBuilder().setSize(300);
////        addSpiritEntry(spiritSubspace, MalumSpiritTypes.SACRED_SPIRIT, 2, -2);
////        addSpiritEntry(spiritSubspace, MalumSpiritTypes.WICKED_SPIRIT, -2, 2);
////
////        addSpiritEntry(spiritSubspace, MalumSpiritTypes.ARCANE_SPIRIT, -3, 0);
////        addSpiritEntry(spiritSubspace, MalumSpiritTypes.ELDRITCH_SPIRIT, 3, 0);
////
////        addSpiritEntry(spiritSubspace, MalumSpiritTypes.AERIAL_SPIRIT, -1, 0);
////        addSpiritEntry(spiritSubspace, MalumSpiritTypes.AQUEOUS_SPIRIT, 0, -1);
////        addSpiritEntry(spiritSubspace, MalumSpiritTypes.EARTHEN_SPIRIT, 1, 0);
////        addSpiritEntry(spiritSubspace, MalumSpiritTypes.INFERNAL_SPIRIT, 0, 1);
