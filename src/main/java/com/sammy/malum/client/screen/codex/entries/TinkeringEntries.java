...
public class TinkeringEntries {
    ...
    public static void setupEntries(ArcanaProgressionScreen screen) {
        ...
        screen.addEntry("spirit_metals.soul_stained_steel", -4, 5, b -> b
                .configureEntry(w -> w.setIcon(SOUL_STAINED_STEEL_INGOT))
        ...
        screen.addEntry("spirit_metals.hallowed_gold", -3, 7, b -> b
                .configureEntry(w -> w.setIcon(HALLOWED_GOLD_INGOT))
        ...
        screen.addEntry("altar_acceleration", -4, 8, b -> b
                .configureEntry(w -> w.setIcon(RUNEWOOD_OBELISK))
        ...
        screen.addEntry("spirit_jar", -5, 8, b -> b
                .configureEntry(w -> w.setIcon(SPIRIT_JAR))
        ...
        screen.addEntry("soulstained_scythe", -5, 6, b -> b
                .configureEntry(w -> w.setIcon(SOUL_STAINED_STEEL_SCYTHE))
        ...
        screen.addEntry("soulstained_armor", -6, 6, b -> b
                .configureEntry(w -> w.setIcon(SOUL_STAINED_STEEL_HELMET))
        ...
        screen.addEntry("reactive_trinkets", -12, 6, b -> b
                .configureEntry(w -> w.setIcon(RING_OF_CURATIVE_TALENT))
        ...
        screen.addEntry("necklace_of_the_mystic_mirror", -14, 5, b -> b
                .configureEntry(w -> w.setIcon(NECKLACE_OF_THE_MYSTIC_MIRROR))
        ...
        screen.addEntry("belt_of_the_starved",-11, 8, b -> b
                .configureEntry(w -> w.setIcon(BELT_OF_THE_STARVED))
        ...
        screen.addEntry("necklace_of_the_narrow_edge", -10, 9, b -> b
                .configureEntry(w -> w.setIcon(NECKLACE_OF_THE_NARROW_EDGE))
        ...
        screen.addEntry("belt_of_the_prospector", -9, 6, b -> b
                .configureEntry(w -> w.setIcon(BELT_OF_THE_PROSPECTOR))
        ...
        screen.addEntry("necklace_of_blissful_harmony", -10, 5, b -> b
                .configureEntry(w -> w.setIcon(NECKLACE_OF_BLISSFUL_HARMONY))
