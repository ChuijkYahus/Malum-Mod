...
public class SpiritInfusionPage extends BookRecipePage<SpiritBasedRecipeInput, SpiritInfusionRecipe> {
    ...
    private static final Map<SpiritArcanaType, Point> SPIRIT_POSITIONS = Map.of(
            SACRED_SPIRIT.get(), new Point(15, 69),
            WICKED_SPIRIT.get(), new Point(95, 102),
            ARCANE_SPIRIT.get(), new Point(95, 36),
            ELDRITCH_SPIRIT.get(), new Point(109, 69),
            AERIAL_SPIRIT.get(), new Point(62, 116),
            AQUEOUS_SPIRIT.get(), new Point(62, 22),
            EARTHEN_SPIRIT.get(), new Point(29, 36),
            INFERNAL_SPIRIT.get(), new Point(29, 102),
            UMBRAL_SPIRIT.get(), new Point(62, 0)
    );
    @Override
...
//        CodexItemHelper.renderIngredients(screen, guiGraphics, recipe.spirits, left + 13, top + 75, mouseX, mouseY, true);
        for (SpiritIngredient ingredient : recipe.spirits) {
            Point p = SPIRIT_POSITIONS.get(ingredient.getSpirit());
