...
public class EntryCommons {
    ...
    public static final DisplayedGizmo SOUL_SHARD = texture(CodexIconRenderer.create(SOUL_SHARD_TEXTURE, 16, 16)).addTitleAndSnippet("icon.soul_shard");
    public static final DisplayedGizmo OVERWORLD = texture(CodexIconRenderer.create(OVERWORLD_TEXTURE, 16, 16)).addTitleAndSnippet("icon.overworld");
}
