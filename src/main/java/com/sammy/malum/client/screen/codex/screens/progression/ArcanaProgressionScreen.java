...
import com.sammy.malum.client.screen.codex.CodexCommons;
...
public class ArcanaProgressionScreen extends AbstractProgressionCodexScreen {
    ...
    public List<BookChapter> getChapters() {
        return List.of(CodexCommons.INTRODUCTION);
    }
...
////                .setBookObjectBuilder((e, x, y) -> new ScreenOpenerObject(e, x, y, VoidProgressionScreen.SCREEN, malumPath("textures/gui/book/icons/void_button.png"), 20, 20))
