...
//                .afterUmbralCrystal();
//
//        screen.addEntry("totem_magic", 0, 12, b -> b
...
//        );
//
//        screen.addEntry("managing_totems", 0, 13, b -> b
...
//        );
//
//        screen.addEntry("undirected_rite", 0, 14, b -> b
...
//        );
//
//        screen.addEntry("unchained_rite", 0, 15, b -> b
//                .setWidgetSupplier(RiteEntryObject::new)
...
//        );
//
//        screen.addEntry("blight", 1, 16, b -> b
...
//        );
//
//        screen.addEntry("scarstone", -1, 16, b -> b
...
//        );
//
//        screen.addEntry("soulwood", 0, 17, b -> b
...
//                .addPage(new UnchainedTransmutationRecipeTreePage("unchained_transmutation.dirt", DIRT))
//                .addPage(new TextPage("unchained_transmutation.stone.1"))
//                .addPage(new UnchainedTransmutationRecipeTreePage("unchained_transmutation.stone", STONE))
//                .addPage(new TextPage("unchained_transmutation.basalt.1"))
//                .addPage(new UnchainedTransmutationRecipeTreePage("unchained_transmutation.basalt", BASALT))
//                .addPage(new TextPage("unchained_transmutation.mud.1"))
//                .addPage(new UnchainedTransmutationRecipeTreePage("unchained_transmutation.mud", MUD))
//                .addPage(new TextPage("unchained_transmutation.packed_mud.1"))
//                .addPage(new UnchainedTransmutationRecipeTreePage("unchained_transmutation.packed_mud", PACKED_MUD))
//                .addPage(new TextPage("unchained_transmutation.snow.1"))
//                .addPage(new UnchainedTransmutationRecipeTreePage("unchained_transmutation.snow", SNOW_BLOCK))
//                .addPage(new TextPage("unchained_transmutation.deepslate.1"))
//                .addPage(new UnchainedTransmutationRecipeTreePage("unchained_transmutation.deepslate", DEEPSLATE))
//        );
//
//        screen.addEntry("aura_empowerment", -3, 17, b -> b
...
//        );
//
//        screen.addEntry("locus_management", 3, 17, b -> b
...
//
//        addBundledRiteEntry(screen, "infernal_rites", -2, 14,
...
//                .setAssociatedSpirit(riteType.get().getIdentifyingSpirit())
