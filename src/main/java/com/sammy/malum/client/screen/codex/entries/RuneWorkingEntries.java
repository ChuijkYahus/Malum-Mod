...
//
//        screen.addEntry("runeworking", -14, 9, b -> b
...
//        );
//
//        screen.addEntry("runic_brooch", -14, 11, b -> b
...
//        );
//
//        screen.addEntry("elaborate_brooch", -13, 12, b -> b
...
//        );
//
//        screen.addEntry("glass_brooch", -15, 12, b -> b
...
//        );
//
//        screen.addEntry("gluttonous_brooch", -14, 13, b -> b
...
//        );
//
//        screen.addEntry("rune_of_vitality", -15, 8, b -> b
...
//        );
//
//        screen.addEntry("rune_of_culling", -16, 8, b -> b
...
//        );
//
//        screen.addEntry("rune_of_dexterity", -17, 9, b -> b
...
//        );
//
//        screen.addEntry("rune_of_scorching", -16, 9, b -> b
...
//        );
//
//        screen.addEntry("rune_of_ailment_cleansing", -16, 10, b -> b
...
//        );
//
//        screen.addEntry("rune_of_protection", -17, 10, b -> b
...
//        );
//
//        screen.addEntry("rune_of_reinforcement", -17, 11, b -> b
...
//        );
//
//        screen.addEntry("rune_of_volatile_distortion", -18, 11, b -> b
