...
public abstract class AbstractRuneCurioItem extends MalumCurioItem implements ParticleEmitterHandler.ItemParticleSupplier {
    ...
    public final SpiritWrapper spiritType;

    public AbstractRuneCurioItem(Properties builder, SpiritWrapper spiritType) {
        super(builder, MalumTrinketType.RUNE);
        this.spiritType = spiritType;
    }
    public AbstractRuneCurioItem(Properties builder, SpiritWrapper spiritType, MalumTrinketType type) {
        super(builder, type);
        this.spiritType = spiritType;
    }
