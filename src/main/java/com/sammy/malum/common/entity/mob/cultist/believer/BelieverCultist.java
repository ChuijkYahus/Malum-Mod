...
public class BelieverCultist extends CultistMonster implements IAltarBlessingRecipient, ICherubFriend {
    ...
    public BelieverCultist(Level level) {
        super(MalumCultistEntityTypes.BELIEVER.get(), MalumCultistSoundEvents.BELIEVER, level);
    }
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType spawnType, @Nullable SpawnGroupData spawnGroupData) {
        setItemSlot(EquipmentSlot.MAINHAND, Items.STONE_SWORD.getDefaultInstance());
