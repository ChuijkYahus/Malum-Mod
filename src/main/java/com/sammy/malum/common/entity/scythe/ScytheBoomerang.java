...
public class ScytheBoomerang extends AbstractScytheProjectileEntity {
    ...
    private static final EntityDataAccessor<Boolean> DATA_NARROW = SynchedEntityData.defineId(ScytheBoomerang.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Boolean> DATA_MAELSTROM = SynchedEntityData.defineId(ScytheBoomerang.class, EntityDataSerializers.BOOLEAN);
