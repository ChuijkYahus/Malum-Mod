...
public class EntityRiteEffectActivator extends FloatingEntity {

    protected static final EntityDataAccessor<SpiritArcanaType> DATA_SPIRIT_GLOW = SynchedEntityData.defineId(EntityRiteEffectActivator.class, MalumEntityDataSerializers.SPIRIT_ARCANA.get());
    ...
    public EntityRiteEffectActivator(Level level, SpiritRiteEntityEffect<?> effect, UUID targetUUID, Vec3 position, Vec3 velocity) {
        this(level);
        this.effect = effect;
