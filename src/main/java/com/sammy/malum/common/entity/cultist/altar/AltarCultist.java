...
public class AltarCultist extends Monster implements Enemy {
    ...
    private static final EntityDataAccessor<Integer> SCALE = SynchedEntityData.defineId(AltarCultist.class, EntityDataSerializers.INT);
    ...
    public void addAdditionalSaveData(CompoundTag compound) {
        ...
        compound.putInt("altarScale", getAltarScale());
    ...
    public void readAdditionalSaveData(CompoundTag compound) {
        ...
        setAltarScale(compound.getInt("altarScale"));
    ...
    public boolean doHurtTarget(@NotNull Entity target) {
        ...
        if (success) {
            ...
            meleeCooldown = RandomHelper.randomBetween(random, 100, 200);
    ...
    public void performRangedAttack(LivingEntity target) {
        boolean isBlessing = target instanceof ICultist;
        triggerSquishAnimation();
    ...
    public Vec3 getProjectileSpawnPos() {
        return position().add(0, 1.5f* getAltarScaleMultiplier(), 0);
    }
    ...
    public void setAltarScale(int scale) {
        entityData.set(SCALE, scale);
    }

    public int getAltarScale() {
    ...
    public float getAltarScaleMultiplier() {
        return 0.7f + getAltarScale() * 0.15f;
    }
