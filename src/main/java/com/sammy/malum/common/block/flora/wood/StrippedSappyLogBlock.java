...
public class StrippedSappyLogBlock extends RotatedPillarBlock {

    public final Supplier<Item> sap;
    public final List<? extends ColorParticleData> sapColor;

    public StrippedSappyLogBlock(Properties properties, Supplier<Item> sap, Color... sapColor) {
        super(properties);
        this.sap = sap;
    ...
    protected ItemInteractionResult useItemOn(ItemStack itemstack, BlockState state, Level level, BlockPos pos, Player player, InteractionHand handIn, BlockHitResult hit) {
        ...
        itemstack.shrink(1);
        SoundHelper.playSound(player, SoundEvents.BOTTLE_FILL);
