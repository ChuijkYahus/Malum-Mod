...
public class VoidDepotBlockEntity extends LodestoneBlockEntity {
    ...
    public void onCompletion() {
        ...
        ParticleEffectTypeRegistry.WEEPING_WELL_REACTS.createPositionedEffect((ServerLevel) level, new NetworkedParticleEffectPositionData(worldPosition.getX()+0.5f, worldPosition.getY()+0.9f, worldPosition.getZ()+0.5f));
