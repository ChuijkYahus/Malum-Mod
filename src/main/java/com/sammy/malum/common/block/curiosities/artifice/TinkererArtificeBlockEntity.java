...
public abstract class TinkererArtificeBlockEntity extends LodestoneBlockEntity {

    protected ArtificeTinkeringInfo info;

    public int closeDelay;

    public TinkererArtificeBlockEntity(LodestoneBlockEntityType<?> type, BlockPos pos, BlockState state) {
