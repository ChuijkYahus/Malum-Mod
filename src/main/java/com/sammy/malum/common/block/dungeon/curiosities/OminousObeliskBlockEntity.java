...
public class OminousObeliskBlockEntity extends ObeliskCoreBlockEntity implements IAltarAccelerator {
    ...
    public static final Supplier<MultiBlockStructure> STRUCTURE = () -> (MultiBlockStructure.of(new MultiBlockStructure.StructurePiece(0, 1, 0, MalumBlocks.OMINOUS_OBELISK_COMPONENT.get().defaultBlockState())));
