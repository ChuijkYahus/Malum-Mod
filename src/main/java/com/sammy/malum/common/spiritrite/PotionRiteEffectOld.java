...
public class PotionRiteEffectOld extends OldTotemicRiteEffect {
    ...
    public PotionRiteEffectOld(SpiritHolder<MalumSpiritType> definingSpirit, Class<? extends LivingEntity> targetClass, DeferredHolder<MobEffect, MobEffect> mobEffectSupplier) {
