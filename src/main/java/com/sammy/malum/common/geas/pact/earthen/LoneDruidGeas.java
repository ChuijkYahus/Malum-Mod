...
public class LoneDruidGeas extends GeasEffect {
    ...
    public void addTooltipComponents(LivingEntity entity, Consumer<Component> tooltipAcceptor, TooltipFlag tooltipFlag) {
        tooltipAcceptor.accept(TooltipComponentHelper.positiveGeasEffect("no_armor_druid_armor"));
        tooltipAcceptor.accept(TooltipComponentHelper.negativeGeasEffect("no_armor"));
    }
