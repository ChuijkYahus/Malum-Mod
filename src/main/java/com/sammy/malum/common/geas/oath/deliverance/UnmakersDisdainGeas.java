...
public class UnmakersDisdainGeas extends GeasEffect {
    ...
    public void addTooltipComponents(LivingEntity entity, Consumer<Component> tooltipAcceptor, TooltipFlag tooltipFlag) {
        tooltipAcceptor.accept(TooltipComponentHelper.positiveGeasEffect("malignant_crit_combo"));
        tooltipAcceptor.accept(TooltipComponentHelper.positiveGeasEffect("malignant_crit_combo_reinforcement"));
