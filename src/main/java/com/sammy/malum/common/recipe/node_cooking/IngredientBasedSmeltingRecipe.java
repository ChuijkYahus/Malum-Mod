...
public class IngredientBasedSmeltingRecipe extends SmeltingRecipe implements INodeCookingRecipe {
    ...
    public IngredientBasedSmeltingRecipe(String group, Ingredient ingredient, Ingredient output, int outputCount, float experience, int cookingTime) {
