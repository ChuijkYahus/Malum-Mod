...
public abstract class OldTotemicRiteEffect {

    public record MalumRiteEffectCategory(ResourceLocation name, int tickRate, int effectWidth, int effectHeight) {
    ...
    protected OldTotemicRiteEffect(MalumRiteEffectCategory category) {
